...
export default function Landing() {
  return (
    <div className="min-h-screen bg-[#F8F9FA] text-[#1A1A1A] font-sans selection:bg-blue-100">
        ...
        <div className="container">
          ...
          >
            <div className="rounded-2xl overflow-hidden shadow-2xl border border-gray-200 bg-white p-2">
              <img 
                src="/images/authentic/mac-app-full.jpg" 
      ...
      <section id="technical" className="py-24 bg-white border-y border-gray-100">
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <motion.div {...fadeIn} className="space-y-6">
              <div className="rounded-2xl overflow-hidden shadow-xl border border-gray-200 bg-white">
                <img src="/images/authentic/lifelog-ui.png" alt="The Lifelog UI" className="w-full" />
              </div>
              <div>
                <h3 className="text-2xl font-bold mb-3">The Lifelog</h3>
            ...
            <motion.div {...fadeIn} transition={{ delay: 0.2 }} className="space-y-6">
              <div className="rounded-2xl overflow-hidden shadow-xl border border-gray-200 bg-white">
                <img src="/images/authentic/ask-ai-ui.png" alt="Ask AI Interface" className="w-full" />
              </div>
              <div>
                <h3 className="text-2xl font-bold mb-3">Ask AI (GPT-5 Powered)</h3>
                <p className="text-gray-600 leading-relaxed">
                  Query your life with natural language. Our AI synthesizes your captured moments 
                  to provide structured, actionable insights.
                </p>
              </div>
            </motion.div>
          </div>
